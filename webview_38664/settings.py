"""
Django settings for webview_38664 project.
...
ROOT_URLCONF = 'webview_38664.urls'
...
WSGI_APPLICATION = 'webview_38664.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "webview_38664 API",
    "DESCRIPTION": "API documentation for webview_38664 App",
    "VERSION": "v1",
}
